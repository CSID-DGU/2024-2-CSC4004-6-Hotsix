...
import FreeBoard from './components/FreeBoard.js'; // 추가
import PostCreate from './components/PostCreate.js'; // 추가
import PostDetail from './components/PostDetail.js'; // 추가
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/freeboard/create" element={<PostCreate />} />
