...
function Header({ isLoggedIn, user, onHomeClick, onCommunityClick, onMyPageClick, onRecommendationCourseClick, onSurveyClick, onLoginClick, onSignupClick, onLogoutClick}) {
      ...
      <header className="header">
        ...
        {isLoggedIn ? (
          <>
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); onLogoutClick(); }} className="auth-link">로그아웃</a>
          </>
        ) : (
          <>
